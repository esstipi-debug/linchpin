...
**42 agent-routable tools** (EOQ, safety stock, `(s,Q)`/`(R,S)`, simulation,
...
cost-to-serve, S&OP, facility location, multi-facility network design (p-median), DRP, transportation, FEFO, launch
