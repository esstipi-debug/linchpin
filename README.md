...
<div align="center">
<img src="docs/assets/capabilities-by-area.png" alt="Donut chart — the 45 registered tools grouped by domain area: inventory & replenishment 11, network & logistics 8, inventory control & health 6, pricing & finance 6, procurement & sourcing 4, demand & classification 3, returns/risk/benchmarking 3, planning cadence 3, leadership 1 (chart image itself pending regeneration; text kept accurate to the current registry)" width="620">
</div>
