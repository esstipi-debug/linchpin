...
**34 registered tools** — source of truth is `build_default_registry()` in
...
| Inventory & replenishment | `inventory_optimization` · `newsvendor` · `multi_echelon` · `ddmrp` · `simulation` · `drp` · `odoo_replenishment` |
