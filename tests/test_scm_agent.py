...
def test_build_default_registry_tools():
    ...
    assert keys == {"inventory_optimization", "pricing", "leadership_chain", "cost_to_serve", "sop", "abc_xyz", "sourcing", "ddmrp", "landed_cost", "whatif", "financial_kpis", "reconciliation", "returns", "warehouse_layout", "queuing", "scheduling", "risk", "forecast", "data_quality", "dea", "acceptance_sampling", "earned_value", "learning_curve", "odoo_replenishment", "excel_replenishment", "newsvendor", "cycle_count", "multi_echelon", "transportation", "fefo", "slotting", "simulation", "digital_twin", "excess_obsolete", "markdown_liquidation", "facility_location", "drp", "vehicle_routing", "price_intelligence", "price_watch", "launch_readiness", "hat_tension", "hat_settlement"}
